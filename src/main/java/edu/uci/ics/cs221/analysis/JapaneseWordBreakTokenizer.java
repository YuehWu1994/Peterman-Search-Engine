...
public class JapaneseWordBreakTokenizer implements Tokenizer {
    ...
    public JapaneseWordBreakTokenizer() {
        try {
            ...
            URL dictResource = JapaneseWordBreakTokenizer.class.getClassLoader().getResource("japanese_dictionary_twitter_freq.txt");
    ...
    private void initializeMap(List<String> dictLines) {
        ...
        for (int i = 0; i < dictLines.size(); i++) {
            ...
            value = Double.valueOf(s.substring(k + 1));
            freqSum += value;
